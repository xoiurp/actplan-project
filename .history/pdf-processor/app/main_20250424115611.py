...
async def extract_pdf(file: UploadFile = File(...)):
    ...
    try:
        ...
        # pendencias_debito_data = extract_pendencias_debito(cleaned_text) # Já chamado acima
...
# Current Time
4/24/2025, 11:55:00 AM (America/Bahia, UTC-3:00)

# Context Window Usage
286,467 / 1,048.576K tokens used (27%)
