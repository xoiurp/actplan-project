...
async def process_situacao_fiscal(file: UploadFile = File(...)):
    ...
    try:
        with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as temp_file:
            ...
            pipeline_options.ocr_options.lang = ["por"] # Portuguese language
            
            # Configurações adicionais para melhorar a detecção de tabelas
            pipeline_options.table_structure_options.min_confidence = 0.5
            pipeline_options.table_structure_options.max_distance = 10
