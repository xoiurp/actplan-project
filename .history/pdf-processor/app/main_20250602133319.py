    ...
    for section_idx, section_start in enumerate(composition_sections):
        ...
        while i < section_end:
            ...
            if codigo_match:
                ...
                print(f"\n🎯 Código DARF encontrado: {codigo} na linha {i+1} (Seção {section_idx + 1})", file=sys.stdout)
                ...
                print(f"✅ Item DARF extraído da seção {section_idx + 1}: {darf_item}", file=sys.stdout)
