...
def extract_parcelamentos_siefpar(text):
    ...
    while i < len(lines):
        ...
        # Tenta encontrar um registro de parcelamento
            # Tenta extrair Parcelamento (apenas dígitos) e Valor Suspenso da mesma linha, permitindo mais espaço entre eles
            ...
            linhas_consumidas_total = 1 # Começa consumindo a linha do parcelamento
            ...
            if linha_modalidade_idx < len(lines):
                ...
                if next_line and not re.match(r"(Parcelamento:|Valor Suspenso:)", next_line, re.IGNORECASE): # Garante que não é outro campo chave
                    ...
                    if modalidade_match:
                         ...
                         # linhas_consumidas_total continua 1
                else:
            ...
            # Incrementa 'i' aqui para garantir que o loop avance
            i += 1
