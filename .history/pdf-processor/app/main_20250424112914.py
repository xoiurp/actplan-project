...
def extract_pendencias_debito(text):
    result = []
    # Identificar a seção de pendências - Tentativa com captura gulosa (sem ?)
    # Captura tudo após "Pendência - Débito (SIEF)" até encontrar outra linha começando com um título de seção, uma linha de underscores longos ou o fim do texto.
