...
async def extract_pdf(file: UploadFile = File(...)):
    ...
    try:
        ...
        print("Texto pré-processado (primeiros 500 caracteres):", cleaned_text[:500], file=sys.stdout)

        # Salva o texto pré-processado em arquivo de log
        with open("openrouter_payload.log", "a", encoding="utf-8") as logf:
            logf.write("\n\n=== NOVA REQUISIÇÃO ===\n")
            logf.write("Texto PRÉ-PROCESSADO enviado à OpenRouter:\n")
            logf.write(cleaned_text) # Usa o texto limpo
            logf.write("\n")

        # Envia o texto pré-processado para a IA
        async with httpx.AsyncClient() as client:
            ...
            data = {
                ...
                "messages": [
                    ...
                    {"role": "user", "content": cleaned_text} # Usa o texto limpo
                ],
                "max_tokens": 30000,
                "temperature": 0.0,
                "response_format": {
