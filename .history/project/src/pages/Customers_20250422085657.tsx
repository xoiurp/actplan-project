...
export default function Customers() {
  ...
  const createMutation = useMutation({
    // Revert to the type that matches the createCustomer signature in api.ts
  ...
  const handleSubmit = useCallback((e: React.FormEvent) => {
    e.preventDefault();
    // Pass formData and explicitly add updated_at: null to match the expected type
    createMutation.mutate({
      ...formData,
      updated_at: null, // Add updated_at as null
      // user_id should ideally be handled within createCustomer in api.ts
    });
