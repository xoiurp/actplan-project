...
import { ArrowLeft, Building2, CreditCard, Calendar, Loader2, Check, FileText, Edit, X, Upload } from 'lucide-react';
                  ...
                  <TableCell>
                    {installment.edit_mode ? (
                      ...
                      <span
                        className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium whitespace-nowrap"
                        style={{
                          backgroundColor: installmentStatusMap[installment.status]?.bg || '#FBE6F2',
                          color: installmentStatusMap[installment.status]?.color || '#E71A4B',
                        }}
                      >
