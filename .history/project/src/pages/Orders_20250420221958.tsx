            ...
            <TableBody>
              {orders.map((order: Order) => (
                ...
                >
                  ...
                  <TableCell>{order.dataPedido || formatDate(order.created_at)}</TableCell>
                  ...
                  <TableCell>
                    ...
                    >
                      {orderStatusMap[order.status]?.label || order.status || 'Pendente'}
                    </span>
                  </TableCell>
                  <TableCell>{formatCurrency(order.total_total)}</TableCell>
                  <TableCell>
