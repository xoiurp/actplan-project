...
export default function EditCustomer() {
  ...
  const { data: customer, isLoading: isLoadingCustomer, isError } = useQuery<Customer | null, Error>({
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    let formattedExpiryDate: string | undefined = certificateExpiryDate ?? undefined; 
    ...
    const finalData: Omit<Customer, 'id' | 'created_at' | 'certificado' | 'user_id'> = {
      ...
      certificado_url: customer?.certificado?.url,
      certificado_nome: customer?.certificado?.nome,
      certificado_validade: formattedExpiryDate, 
