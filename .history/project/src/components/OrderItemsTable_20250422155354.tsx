...
export function OrderItemsTable({ 
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-start mb-4"> {/* Changed items-center to items-start for better alignment with vertical buttons */}
        <h3 className="text-lg font-medium">Itens do Pedido</h3>
        <div className="flex flex-col space-y-2 items-end"> {/* Changed to flex-col, space-y-2, items-end */}
          <button
            type="button"
