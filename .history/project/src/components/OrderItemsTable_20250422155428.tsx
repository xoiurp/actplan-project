...
export function OrderItemsTable({ 
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center mb-4"> {/* Reverted to items-center */}
        <h3 className="text-lg font-medium">Itens do Pedido</h3>
        <div className="flex flex-col space-y-3 items-end pt-1"> {/* Added pt-1 for padding-top */}
          <button
            type="button"
