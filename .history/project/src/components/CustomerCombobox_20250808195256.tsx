...
const staticCustomers = [
    { label: "Cliente Teste 1", value: "1" },
    { label: "Cliente Teste 2", value: "2" },
    { label: "Cliente Teste 3", value: "3" },
];
...
export function CustomerCombobox() {
  ...
  const customerList = staticCustomers;
              ...
              {isLoading ? (
                ...
                customerList.map((customer) => (
                  <CommandItem
                    key={customer.value}
                    onSelect={() => {
                      setValue(customer.value === value ? "" : customer.value);
                      setOpen(false);
                    }}
                  >
                    <Check
