  ...
  return (
    <div className="relative flex min-h-screen">
      <SidebarProvider defaultOpen>
        <Sidebar className="group peer hidden text-sidebar-foreground md:block" data-state="expanded" data-variant="inset" data-side="left">
          ...
          <SidebarContent className="flex min-h-0 flex-1 flex-col gap-2 p-2">
