...
export function OrderItemsTable({ 
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center mb-4 py-4"> {/* Kept py-4 for vertical padding */}
        <h3 className="text-lg font-medium">Itens do Pedido</h3>
        <div className="flex space-x-4"> {/* Increased horizontal space to space-x-4 */}
          <button
            type="button"
