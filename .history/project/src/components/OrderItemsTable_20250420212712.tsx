            ...
            {itens_pedido.length === 0 ? (
              ...
              itens_pedido.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell>{item.startPeriod}</TableCell>
                  <TableCell>{item.endPeriod}</TableCell>
                  <TableCell>{item.dueDate}</TableCell>
                  <TableCell className="text-right whitespace-nowrap">{formatCurrency(item.originalValue)}</TableCell>
                  ...
                  <TableCell className="text-right whitespace-nowrap">{formatCurrency(item.currentBalance)}</TableCell>
